        ...
        return (
            <div className="max-w-4xl mx-auto px-6 py-16">
                <div className="text-center">
                    <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-primary-500/10 border border-primary-500/20 text-primary-400 text-xs font-black uppercase tracking-[0.2em] mb-8">
                        <Shield size={14} />
                        <span>Security Lockdown</span>
                    </div>
                    <h1 className="text-5xl lg:text-6xl font-black text-white tracking-tighter mb-6 leading-tight">
                        Connect Your <span className="text-primary-500 text-transparent bg-clip-text bg-gradient-to-r from-primary-400 to-primary-500 text-6xl">Gmail</span> Intelligence.
                    </h1>
                    ...
                    <button
                        onClick={handleLogin}
                        className="group flex items-center gap-3 px-8 py-4 rounded-2xl bg-primary-600 hover:bg-primary-500 text-white text-lg font-bold transition-all shadow-2xl shadow-primary-600/30 active:scale-95 mx-auto"
                    >
                        <Brain size={24} />
                        Login with Google
