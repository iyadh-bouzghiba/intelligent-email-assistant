            ...
            <div className="max-w-4xl mx-auto px-6 py-16">
                <div className="text-center">
                    ...
                    <h1 className="text-5xl lg:text-6xl font-black text-white tracking-tighter mb-6 leading-tight">
                        Power Your <span className="text-primary-500 text-transparent bg-clip-text bg-gradient-to-r from-primary-400 to-primary-500 text-6xl">Replies</span> with AI.
                    </h1>
