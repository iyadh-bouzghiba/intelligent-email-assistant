...
-- 10) ACCOUNT INTELLIGENCE PROFILES (USER-INTELLIGENCE-STATE-01 — per-account observed behaviour)
...
-- 11) SENT EMAILS (schema authority restored by P5.5 — was runtime-only, now documented)
...
-- service_role bypasses RLS (backend runtime safety);
-- authenticated role is scoped to its own account_id via JWT sub.
-- ============================================================
